...
describe 'base_windows::network' do
  ...
  context 'create the log locations' do
    ...
    it 'creates the unbound logs directory' do
      expect(chef_run).to create_directory(unbound_logs_path)
    end
  end
  ...
  context 'create the unbound locations' do
    ...
    it 'creates the unbound config directory' do
      expect(chef_run).to create_directory(unbound_config_path)
    end

    it 'creates the unbound bin directory' do
  ...
  context 'install unbound as service' do
    ...
    unbound_default_config_content = <<~CONF
      ...
      include: "#{unbound_config_path}/unbound_zones.conf"
      ...
      server:
          ...
          logfile: "#{unbound_logs_path}/unbound.log"
